...
export const themes: ThemeMeta[] = [
  {
    ...
    shortLabel: "有給",
    basePath: "/paid-leave",
    description: "JKS の有給取得を、制度・運用・管理職行動まで落として読めるライブラリ",
    heroTitle: "JKS の有給取得促進を、制度案の粒度まで読めるテーマ。",
    heroDescription:
      "低取得者対策、管理職施策、推奨日設計、属人化対策まで、JKS の会議体や運用設計へ載せやすい粒度で整理しています。",
    focusLabel: "低取得者 / 管理職 / 推奨日設計",
    entrySummary: "JKS の制度化に寄せた比較に強い",
  ...
  },
  {
    ...
    shortLabel: "睡眠",
    basePath: "/sleep",
    description: "JKS のデスクワークから運用・支援業務までを見据えて、会社として睡眠課題へどう介入するかを読むライブラリ",
    heroTitle: "JKS の睡眠課題への介入策を、運用改善として読めるテーマ。",
    heroDescription:
