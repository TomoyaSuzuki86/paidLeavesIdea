...
export function IdeaDetailLayout({ idea, themeKey, relatedIdeas }: IdeaDetailLayoutProps) {
  return (
    <div className="detail-layout">
      <ScrollReveal as="section" className="detail-hero card">
      ...
      <div className="detail-columns">
        <div className="detail-main">
          <ScrollReveal as="section" className="detail-section card">
        ...
        <aside className="detail-side">
          <ScrollReveal as="section" className="card detail-side-card">
            <h2>見込める効果</h2>
